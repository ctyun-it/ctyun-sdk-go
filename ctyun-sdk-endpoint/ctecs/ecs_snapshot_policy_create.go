...
// EcsSnapshotPolicyCreateApi
type EcsSnapshotPolicyCreateApi struct {
	ctyunsdk.CtyunRequestBuilder
	client *ctyunsdk.CtyunClient
}

func NewEcsSnapshotPolicyCreateApi(client *ctyunsdk.CtyunClient) *EcsSnapshotPolicyCreateApi {
	return &EcsSnapshotPolicyCreateApi{
		client: client,
...
func (this *EcsSnapshotPolicyCreateApi) Do(ctx context.Context, credential ctyunsdk.Credential, req *EcsSnapshotPolicyCreateRequest) (*EcsSnapshotPolicyCreateResponse, ctyunsdk.CtyunRequestError) {
	builder := this.WithCredential(&credential)

	_, err := builder.WriteJson(&EcsSnapshotPolicyCreateRealRequest{
	...
	var realResponse EcsSnapshotPolicyCreateRealResponse
	err = response.ParseByStandardModelWithCheck(&realResponse)
	if err != nil {
		return nil, err
	}

	return &EcsSnapshotPolicyCreateResponse{
...
type EcsSnapshotPolicyCreateRealRequest struct {
...
type EcsSnapshotPolicyCreateRealResponse struct {
	SnapshotPolicyStatus int    `json:"snapshotPolicyStatus,omitempty"`
	SnapshotPolicyName   string `json:"snapshotPolicyName,omitempty"`
	RetentionType        string `json:"retentionType,omitempty"`
